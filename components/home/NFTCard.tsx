  ...
  return (
    <Link href={`/${props.nft ? "nftDetail" : "dlcDetail"}/${props.id}`}>
      <div className="relative w-[331px]">
        <div className={`relative flex flex-col ${props.avartar ? "border-2 border-[#0F1421]" : "bg-[#080B13]"} rounded-[40px] p-6 z-20 relative"`}>
          ...
          <div className="flex justify-start items-center space-x-[18px] mt-6">
            {
              props.nft ? (
                ...
                <div className="relative">
                  <div className="flex items-center bg-[#393637] rounded-[40px] px-[10px] py-[2px] h-6 relative z-20">
